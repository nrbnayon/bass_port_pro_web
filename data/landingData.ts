...
export const reports: ReportCard[] = [
  {
    ...
    temp: "72°F",
    catches: "18 catches",
    text: "Incredible day on Guntersville! The grass is loaded with fish. Started Flipping mats early and switched to swim jigs mid-morning. Topwater bite turned o...",
  ...
  },
  {
    ...
    temp: "58°F",
    catches: "8 catches",
    text: "Pre-spawn bite is starting to heat up. Fish are moving up from winter holes to staging areas. Jerk baits in 8-12ft producing quality bites. creolin...",
  ...
  },
  {
    ...
    temp: "74°F",
    catches: "22 catches",
    text: "The Big O is fishing phenomenally right now. Flipping heavy mats with a 1oz tungsten weight and creature bait. Frog bite is insane in the Monkey B..",
    tags: ["Flipping", "Frogs"],
    avatarColor: "bg-[#FF6B35]",
  },
];
