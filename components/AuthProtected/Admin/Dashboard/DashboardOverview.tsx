        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatsCard
              ...
              iconBgColor="#F3F4F6"
              iconColor="#6B7280"
              subtitle={`+${stats.totalUsers.trend}% From last month`}
              isUp={true}
            />
            <StatsCard
              title="Total Lakes"
              ...
              iconBgColor="#DCFCE7"
              iconColor="#22C55E"
              subtitle={`+${stats.totalLakes.trend} Active locations`}
              isUp={true}
            />
            <StatsCard
              title="Reports"
              ...
              iconBgColor="#FFEDD5"
              iconColor="#F97316"
              subtitle={`+${stats.totalReports.trend} This month`}
              isUp={true}
            />
            <StatsCard
              title="Lake Request"
              ...
              iconBgColor="#CFFAFE"
              iconColor="#06B6D4"
              subtitle={`+${stats.lakeRequests.trend} This month`}
              isUp={true}
            />
          </div>
        )}
